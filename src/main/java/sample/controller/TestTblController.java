...
//
//		String userSampleId = (String) request.getAttribute("sampleId");
//
...
//		testTblModel.setListSampleTblBean(testTblService.selectSampleTblList(insertTblPara.getTestNum()));
//
...
//	}
	...
	public String selectTestTbl(@ModelAttribute("selectTblPara") SelectTblPara selectTblPara, 
		...
		// testTblModel.setListSampleTblBean(testTblService.selectSampleTblList(selectTblPara.getTestNum()));
